...
assert(!/\bimport\s*\(|\beval\s*\(|new Function\b|https?:\/\//.test(code), 'Unexpected runtime loader, executable evaluator or external URL');
for (const path of ['design/reference/aw-theme.css', 'src/panel.css'])
...
const links = [[bookmark, 'API Workbench M0']];
