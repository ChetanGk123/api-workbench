...
- Next: verify the deployed installer at `https://chetangk123.github.io/api-workbench/install.html`, then install from it as a real saved bookmark and confirm one update-check round trip from a third-party application page.
