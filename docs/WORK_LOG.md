...
- Next: after this deploys, press Check for update from a 1.0.3 bookmark against the live 1.0.4 site, copy, paste into a real saved bookmark and relaunch — the first end-to-end proof of the whole path.
